...
function HomeNavbar() {
    ...
    // Fetch image when userData is available
    useEffect(() => {
                        ...
                        {userData ? (
                            <Link to="/Profile" >
                                <img
                                    ...
                                    alt="Profile"
                                    className="rounded-full w-[45px] h-[45px] object-cover border-[2.4px] border-green-400 ms-96 "

                                />
                            </Link>
                        ) : (
                            <Link to="/Login">
                                <button className="ms-72 bg-transparent border border-[#006AFF] text-[#006AFF] w-[100px] px-4 py-2 shadow-md hover:bg-[#006AFF] hover:text-white transition duration-200">
                                    Sign In
                                </button>
                            </Link>
                        )}
