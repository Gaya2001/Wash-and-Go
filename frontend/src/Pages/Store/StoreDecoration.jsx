...
const products = [
    { id: 1, imageUrl: 'Product1.png', title: 'Decorations 1', price: '$10', count: '10' },
    ...
    return(
        <div className=" h-screen w-screen ">
            ...
            <div className="flex justify-start bg-white shadow-md mt-10 px-20 h-14 gap-8">
                ...
                className="bg-white text-black border-2 border-gray-300 rounded-md focus:outline-none h-full px-20">Oil</button>
                <button className="bg-blue-500 text-white border-2 border-gray-300 rounded-md focus:outline-none h-full px-11">Decorations</button>
                <button
