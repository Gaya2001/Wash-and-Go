                                ...
                                {['FirstName', 'LastName', 'NIC', 'MobileNumber', 'Email', 'Address'].map((field) => (
                                    <div key={field}>
                                        ...
                                        <input
                                            ...
                                            className={`w-full border border-gray-300 p-3 mt-1 rounded-lg focus:ring-2 focus:ring-blue-500 transition duration-200 ${field === 'NIC' ? 'bg-gray-200 outline-none' : ''}`}
